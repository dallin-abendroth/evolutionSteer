...
class Creature extends PApplet{
  ...
  Creature modified(int id, float mutationFactor) {
    ...
    if (random(0, 1) < evolutionSteer.bigMutationChance*mutationFactor*(5-this.brain.BRAIN_WIDTH)/2 && this.brain.BRAIN_WIDTH < 5) { bigMutExpandBrain = true; } 
    ...
    newN, newM, 0, true, creatureTimer+r()*16*modMut, newMut, tmpBrain,null,parent);
